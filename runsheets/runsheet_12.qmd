...
## By the end of today's seminar, you should be able to
 ...
 + Write out an appropriate (log) likelihood function in `R` and optimise 
...
**Be prepared to present your activity to me/the class**!
...
"Read" the following cheatsheets:
...
**Summarise each  via [StatChat](https://canvas.auckland.ac.nz/courses/141056/external_tools/38296)** 
