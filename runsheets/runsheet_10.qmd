...
## <i class="fa fa-question-circle" aria-hidden="true"></i> <i class="fa fa-users" aria-hidden="true"></i> <i class="fa fa-pencil-square" aria-hidden="true"></i> When prompted name the distribution and answer with [StatChat](https://canvas.auckland.ac.nz/courses/141056/external_tools/38296)

<b> Please only write the name of the distribution, e.g. "Exponential", but be prepared to justify your choice.</b><br>
<b> You might want to look back at Monday's notes especially the [cheatsheet](https://raw.githubusercontent.com/BIOSCI738/cowstats/main/img/distributions.png).</b><br>

<ol>

  <li> From drone footage the number of people on the UoA campus is recorded</li>
    
  <li> A lecturer counts how many of the students enrolled in their course attend a lecture</li>
  
  <li> The discharge of a river is measured</li>
  
  <li> Commuters time how long their trip takes</li>
  
  <li> CANVAS tracks how many times a student attempts a quiz with unlimited attempts</li>
  
  <li> The number of surviving chicks raised by a pair of takahē</li>
  
  <li> Students are interviewed about whether they went to campus in-person that day</li>
  
  <li> A statistician notes the length of songs played at a music festival</li>
...
<p align="center">
<iframe src="slides/GLM_Diagnostics.pdf" height="400" width="700" title="Generalised Linear Model Diagnostics"></iframe>
</p>
...
## Activities {#sec-glmfit}

In your groups work through the examples below. After each model is fitted assess its fit using the code/functions provided. Discuss each model's suitability. Discuss the similarity and/or differences to previous models.
...
# 2. Calculate the p-value of the chi-squared test on the deviance and save it as p_value_binom
```
...
:::{.callout-warning icon=false}
## <i class="fa fa-question-circle" aria-hidden="true"></i> <i class="fa fa-users" aria-hidden="true"></i> <i class="fa fa-pencil-square" aria-hidden="true"></i> Some homework

By the end of the week, to the `tasks` folder of your GitHub repository add and push a **fully reproducible** `R` script named `week_06.r` that performs the two  *TODO* tasks at the end of the lobster example and the one task for Model 2 of the birds example. Remember to **read in any required data** & update your `README.md` accordingly!
:::