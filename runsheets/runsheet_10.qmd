...
## Rough Agenda
 ...
 + **2:05–2:30 pm** Guess the distribution (@sec-distribution)
 + **2:30–2:45 pm** Writing out (G)LM(m)s (@sec-writingglm)
 + **2.45–3:45 pm** Assessing model fit (@sec-glmfit)
   - Class discussion 
   - Group activities

 + **3.45–3.55 pm** Q&A (@sec-peershare11)
...
By the end of the week, to the `tasks` folder of your GitHub repository add and push a **fully reproducible** `R` script named `week_06.r` that performs the two  *TODO* tasks at the end of the lobster example. Remember to **read in any required data** & update your `README.md` accordingly!
:::
