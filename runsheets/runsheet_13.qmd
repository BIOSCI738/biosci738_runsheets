...
## <i class="fa fa-question-circle" aria-hidden="true"></i> <i class="fa fa-users" aria-hidden="true"></i> <i class="fa fa-pencil-square" aria-hidden="true"></i> When prompted answer via [StatChat](https://canvas.auckland.ac.nz/courses/141056/external_tools/38296)...
...
...a candidate distribution for $p$  via [StatChat](https://canvas.auckland.ac.nz/courses/141056/external_tools/38296)
...
In your groups work through the section below (previously seen example from @sec-glmfit) and discuss the prompts and plots etc. 
