...
To the `tasks` folder of your GitHub repository create, add and push a reproducible Rmarkdown (`.Rmd`) file called `week_03.Rmd` with a completed version of the table below. [LEARN about Rmarkdown files here](https://rmarkdown.rstudio.com/lesson-2.html). Remember to update your `README.md` accordingly!

| Feature | Bootstrap | Permutation (residuals – reduced model) | Permutation (residuals – full model) | Permutation (observations) |
|--------|-----------|-------------------------------------------|---------------------------------------|-----------------------------|
| Goal of the method |  |  |  |  |
| What is resampled or shuffled? |  |  |  |  |
| Is sampling done with replacement? |  |  |  |  |
| What distribution is generated? |  |  |  |  |
