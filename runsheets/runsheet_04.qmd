...
CI_non_parametric
## What do you think is going on here and why.
...
input { padding: 4px; margin: 6px 0; }
</style>

<!-- Logic -->
<script>
function check(id, ans, tol=0){
  let el = document.getElementById(id);
  let v = el.value.trim();

  if(!isNaN(ans)){
    let num = parseFloat(v);
    if(!isNaN(num) && Math.abs(num - ans) <= tol){
...
<!-- Questions -->
1. Under the additive model how much of a kilogram does a pumpkin increase on average for every millimeter (mm) in height? (*2 dps*) <input id="q1" oninput="check('q1',0.03,0.001)">

2. Estimated weight of Pumpkin 2 (kg) (*2 dps*) <input id="q2" oninput="check('q2',1.477,0.01)">

3. Ratio of pumpkin 1 weight to pumpkin 2 weight (additive model) (*2 dps*) <input id="q3" oninput="check('q3',3.38,0.05)">

4. Which bootstrap gives the wider 95% confidence interval, parametric or non-parametric? <input id="q4" oninput="check('q4','non-parametric')">
