...
## Rough timeline
 ...
 + **09:05–09:25 am** Reverse engineer (@sec-draw)
 + **09:25–09:55 am** Linear model diagnostics
   - Recap residual plots {@sec-qq}
   - Fry time (@sec-fry)
   
 + **09:55–10:05 am** Break
 + **10.05–10.20 am** Polynomials (@sec-poly)
 + **10.20–10.55 am** Communicating statistics (@sec-comm)
...
[Here is a handout](https://canvas.auckland.ac.nz/courses/120054/files/14903576?module_item_id=2564916) with nothing but data summaries and linear model summary output given. Draw the models and upload your pictures to  this [Google Doc](https://docs.google.com/document/d/1QCAqp8EIxCZwh4PImcpVz9LzGGaO29Q3ET3EszV8kWg/edit?usp=sharing).
...
## Discuss your chosen paper {#sec-project}
...
As the **Client** answer the following questions about your chosen paper for your [written report](https://canvas.auckland.ac.nz/courses/120054/assignments/436873).
...
## <i class="fa fa-question-circle" aria-hidden="true"></i> <i class="fa fa-users" aria-hidden="true"></i> <i class="fa fa-pencil-square" aria-hidden="true"></i> Head over to this [Google Doc](https://docs.google.com/document/d/1QCAqp8EIxCZwh4PImcpVz9LzGGaO29Q3ET3EszV8kWg/edit?usp=sharing)...
 ...
 3. Discuss/write out what amendments would you like to see to the proposed rubic (see assignment) so that, as you see it, it better reflects your input (I will update the rubric accordingly if I deem the suggestions a better reflection of effort!)
