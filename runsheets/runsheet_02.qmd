...
To the `tasks` folder of your GitHub repository push a reproducible `R` script named `week_02.r` that simulates these data as best you can. Remember to update your `README.md` accordingly.
