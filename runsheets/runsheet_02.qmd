...
In your groups take a look at **Figure 1** from the following publication and **roast** (yes you can be as mean as you like, honestly) or admire it^[Note that your lecturer is an author of the publication and she consents to the roasting!]

 + [Colours of the Taylor Swift universe: a statistical story](https://academic.oup.com/jrssig/article/23/1/12/8380148)

Figure 1 shows which "surprise" dresses were worn during which concerts in Taylor Swift's Eras Tour.  According to the text of the article, Figure 1 is supposed to show:
...
You will have no doubt read and digested [this section of the course guide](https://biosci738.github.io/BIOSCI738/data-visualization.html), so you will have some basis for critiquing the plot.

We will discuss your responses and some general approaches to critically assessing data visualizations.
