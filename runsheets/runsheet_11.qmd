# Week 07 - Lecture 01^[Much of the content was taken/modified, with permission, from [Dr Liza Bolton's 2025 materials](https://lizabolton.github.io/2025-biosci738-ethics/#/title-slide)]
...
(*We will finish a little early to accommodate those with IOAs, note there will be no office hour after this lecture for the same reason*)
 ...
 + Ethical data practices
   + Your ethical experiences and codes of conduct (@sec-coc2liza)
...
## <i class="fa fa-question-circle" aria-hidden="true"></i> <i class="fa fa-users" aria-hidden="true"></i> <i class="fa fa-pencil-square" aria-hidden="true"></i> You hate your friend’s new haircut...

![*Google (2025) Gemini AI generated image from prompt: Create a lifelike image of 21-year-old person with a really terrible broccoli haircut. Truly disastrous, please. The hair should be green.*](runsheets/img/haircut.jpeg)

If they ask you what you think, what do you say? **Tell us via [StatChat](https://canvas.auckland.ac.nz/courses/141056/external_tools/38296)**

:::

## Ethical data practicies
...
### Codes of conduct {#sec-coc2liza}

Recall, when you developed a Code of Conduct for this course (i.e., @sec-coc)? You should have also seen the [Waipapa Taumata Rau | University of Auckland Code of Conduct](https://www.auckland.ac.nz/en/about-us/about-the-university/statements-codes/code-of-conduct.html) that applies to you as a student here.
...
For people working in research and academia there are usually professional societies that have developed codes of conduct and ethical standards (e.g., [The Royal Society Te Apārangi](https://www.royalsociety.org.nz/)).
:::
...
2. Read over the [Royal Society Te Apārangi](https://www.royalsociety.org.nz/assets/Uploads/Code-Overview-A3-web.pdf) Code of Professional Standards and Ethics in Science, Technology, and the Humanities. Describe a possible workflow for biological research. Come up with possible ethical decisions for each stage.


### Ethical (statistical) data practices

(Remember @sec-prog_practice)

**Reproducibility, transparency, open data**

 1. Making data and code available (freely online, or *upon application to the author*)
    +  Tools like GitHub or platforms like the [Open Science Framework (OSF)](https://www.cos.io/products/osf) are popular
 2. Approaching you code writing in reproducible ways
 3. Making it possible for others to replicate your methods and analyses
 
**Indigenous data sovereignty** 

[Module 1](https://biosci738.github.io/BIOSCI738/module-1.html) in your coursebook includes notes about data sovereignty, especially principles around Indigenous Data Sovereignty. However, some advice and concepts that are commonly promoted in open data and transparency movements are directly counter to sovereignty over data. 
...
Here is a brief article on the subject I recommend reading
[RNZ. (2024). Māori AI expert Dr Karaitiana Taiuru shares his favourite whakataukī.](https://www.rnz.co.nz/news/national/512062/maori-ai-expert-dr-karaitiana-taiuru-shares-his-favourite-whakatauki). Additionally, a video worth watching: [Data Democratisation Panel from the Science Communicators Association of New Zealand (2023)](https://www.youtube.com/embed/8cBOIyoISbY?si=Jxudp8MRIy60ObBZ)

**Researcher degrees of freedom**

  + Your decisions matter!
  + You are already familiar with *degrees of freedom* from @sec-mods. This value tells us something about how many independent pieces of information go into our estimation of the parameter we’re interested in.
 + However, *researcher degrees of freedom* are a way of discussing the flexibility and range of ways we might approach collecting and measuring data.

See @researcherdf for more in-depth discussion.
...
Doing the work is not enough — you need to make sure that communication to stakeholders about your work and results is done accurately and honestly.
 ...
 + Appropriate data visualisations (we had a [whole lecture on data viz](https://biosci738.github.io/biosci738_runsheets/#week-04---lecture-02-guest-lecturer-paul-murrell)!)
...
:::{.callout-warning icon=false}
## <i class="fa fa-question-circle" aria-hidden="true"></i> <i class="fa fa-users" aria-hidden="true"></i> <i class="fa fa-pencil-square" aria-hidden="true"></i> Data ethics in the real world

As **a group** choose one real-world scenario from [this collated list](https://deon.drivendata.org/examples/), which compiles *examples of times when tradeoffs were handled well, and times when things have gone wrong*.

Discuss how you might employ or avoid the strategy detailed relative to your own work. For example, how might you ensure the your visualizations, summary statistics, and reports are designed to honestly represent the underlying data?


In [StatChat](https://canvas.auckland.ac.nz/courses/141056/external_tools/38296) **individually** summarise the conclusions you drew above. 
:::
...
**As a group**
   ...
   1. Write the null and alternative hypothesis for this test in context.
   2. Identify some possible issues with this interpretation based on limitations of your data collection. Write a short explanation for the mine executive about how these issues could affect the interpretation of your result.
...
:::{.callout-warning icon=false}
## <i class="fa fa-question-circle" aria-hidden="true"></i> <i class="fa fa-users" aria-hidden="true"></i> <i class="fa fa-pencil-square" aria-hidden="true"></i> Ethics Checklist

By the end of the week, to the `tasks` folder of your GitHub repository add and push a `.txt` file named `week_07.txt` that contains a completed [Ethics checklist](https://deon.drivendata.org/#data-science-ethics-checklist) for one of the imagined case studies above. Note that not all points will necessarily apply, however you should be explicit about this and briefly outline why this is the case.

DRIVENDATA do also provide an example of a rendered [![](https://img.shields.io/badge/ethics%20checklist-deon-brightgreen.svg?style=popout-square)](http://deon.drivendata.org/) in a `.txt` format
[here](https://github.com/drivendataorg/deon/blob/main/examples/ethics.txt).
:::
